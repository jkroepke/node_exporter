...
xfs\_quota | Exposes XFS project quota usage and limits. Requires `CAP_SYS_ADMIN`. Project path information from `/etc/projects` can be enabled with `--collector.xfs_quota.project-info`. | Linux
